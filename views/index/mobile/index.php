    ...
    <!-- 이미지 슬라이드 영역 -->
        <section class="slide" style="visibility: hidden;">
            <ul >
                ...
                <li><img src="<?php echo base_url('assets/images/temp/slide_img/slide_img01.png'); ?>" alt="main_01"></li>
                <li><img src="<?php echo base_url('assets/images/temp/slide_img/slide_img02.png'); ?>" alt="main_02"></li>
                <li><img src="<?php echo base_url('assets/images/temp/slide_img/slide_img03.png'); ?>" alt="main_03"></li>
            </ul>
            <h2>A resort for you only! You can get all the information<br>
                you need in one trip to Philippines.</h2>
        </section>
